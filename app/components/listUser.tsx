...
import { View, Text, FlatList, Alert, ActivityIndicator, StyleSheet, TouchableOpacity, Image } from 'react-native';
...
const UserList = () => {
    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            Alert.alert('Erreur', 'Erreur lors de la récupération des utilisateurs.'+error);
    ...
    //desactivation du compte d un utilisateur
...
const styles = StyleSheet.create({
    ...
    userInfo: {
        flex: 1,
        marginRight: 10,
        flexDirection: "row",  // Aligner l'image et les informations sur la même ligne
        alignItems: "center",
    },
    userText: {
        fontSize: 16,
    ...
    userImage: {
        ...
        borderRadius: 25,  // Pour donner un aspect circulaire
